...
# For a good explanation of how this function works, see this post:
...
polygon(
  x = c(seq_along(irf1data$gpr), rev(seq_along(irf1data$gpr))),
...
polygon(
  x = c(seq_along(irf1data$ip), rev(seq_along(irf1data$ip))),
...
polygon(
  x = c(seq_along(irf1data$sp500), rev(seq_along(irf1data$sp500))),
...
polygon(
  x = c(seq_along(irf1data$epu), rev(seq_along(irf1data$epu))),
