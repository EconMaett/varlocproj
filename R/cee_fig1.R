...
plot(irf1data$ffr,
  type = "l", main = "Federal funds rate",
  xlab = "", ylab = "",
  ylim = c(min(irf1data$ffr.1), max(irf1data$ffr.2)) * 1.1
)
polygon(
  x = c(seq_along(irf1data$ffr), rev(seq_along(irf1data$ffr))),
...
plot(irf1data$lip,
  type = "l", main = "Industrial production",
  xlab = "", ylab = "",
  ylim = c(min(irf1data$lip.1), max(irf1data$lip.2)) * 1.1
)
polygon(
  x = c(seq_along(irf1data$lip), rev(seq_along(irf1data$lip))),
...
plot(irf1data$unemp,
  type = "l", main = "Unemployment",
  xlab = "", ylab = "",
  ylim = c(min(irf1data$unemp.1), max(irf1data$unemp.2)) * 1.1
)
polygon(
  x = c(seq_along(irf1data$unemp), rev(seq_along(irf1data$unemp))),
...
polygon(
  x = c(seq_along(irf1data$lcpi), rev(seq_along(irf1data$lcpi))),
...
plot(irf1data$lip,
  type = "l", main = "Commodity prices",
  xlab = "", ylab = "",
  ylim = c(min(irf1data$lpcom.1), max(irf3data$lpcom)) * 1.1
)
polygon(
  x = c(seq_along(irf1data$lpcom), rev(seq_along(irf1data$lpcom))),
...
plot(irf1data$lnbr,
  type = "l", main = "Nonborrowed reserves",
  xlab = "", ylab = "",
  ylim = c(min(irf1data$lnbr.1), max(irf1data$lnbr.2)) * 1.1
)
polygon(
  x = c(seq_along(irf1data$lnbr), rev(seq_along(irf1data$lnbr))),
...
plot(irf1data$ltr,
  type = "l", main = "Total reserves",
  xlab = "", ylab = "",
  ylim = c(min(irf2data$ltr), max(irf2data$ltr)) * 1.1
)
polygon(
  x = c(seq_along(irf1data$ltr), rev(seq_along(irf1data$ltr))),
...
polygon(
  x = c(seq_along(irf1data$lm1), rev(seq_along(irf1data$lm1))),
